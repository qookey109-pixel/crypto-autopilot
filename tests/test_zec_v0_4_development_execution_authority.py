...
class ZecV04DevelopmentExecutionAuthorityTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_exact_merged_authority_opens_only_bounded_development(self) -> None:
        ...
        self.assertEqual(self.payload["authority_pr_number"], 418)
        self.assertEqual(self.payload["execution_scope"]["development_matrix_cells"], 24)
        ...
        self.assertFalse(
            self.payload["safety_boundary"]["fresh_confirmation_access_authorized"]
        )

...
SPEC = importlib.util.spec_from_file_location(
    "zec_v0_4_execution",
    ROOT / "scripts/run_zec_v0_4_development_execution_v0_1.py",
)
...
class ZecV04DevelopmentExecutionScriptTests(unittest.TestCase):
    ...
    def test_wrong_authority_id_fails_before_github_or_provider_access(self) -> None:
        ...
        with self.assertRaisesRegex(
            module.ZecV04ExecutionPreflightError,

...
class DetailedHistoryWorkflowTests(unittest.TestCase):
    ...
    def test_training_workflow_reads_complete_dataset_and_never_promotes(self) -> None:
        ...
        self.assertIn("train_binance_detailed_history_models_v0_3.py", text)
        self.assertIn("core100_training_fingerprint_v0_1.json", text)
        self.assertIn('{"PASS", "NO_CHANGE"}', text)

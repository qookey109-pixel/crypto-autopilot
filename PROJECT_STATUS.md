...
- The 2026-09-22 triage snapshot recorded a reviewed open pull-request backlog of zero; it is historical. At the 2026-09-23 checkpoint, #477 was open and #478 was merged. Resolve live GitHub PRs before acting. The #326–#331 dependency batch has been reviewed: #447/#448 merged the compatible current-main action updates, while incompatible/freeze-crossing proposals were closed without merge. Older architecture-generation and draft-salvage PRs remain historical references.

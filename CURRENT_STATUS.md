...
| 3 | Core100 fingerprint V0.2 | PR #494 merged the frozen preparation contract; a pure comparator validates the 36-entry prepared inventory and caller-attested runtime. V0.2 remains PREPARED_NOT_ACTIVE; legacy pointer migration is REVIEW_REQUIRED. A cloud-only successor cutover proposal is prepared at [proposal](docs/CORE100_TRAINING_FINGERPRINT_V0_2_CUTOVER_PROPOSAL.md), based on main e1d037d570e8641442448fad50422ca6f217b8aa; it adds no activation authority. Next: review the proposal, exact import closure, baseline policy, and separately versioned activation requirements. |

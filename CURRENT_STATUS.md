...
| 3 | Core100 fingerprint V0.2 | PR #501 merged a non-authorizing cutover proposal at b150c965. PR #502 merged the GitHub-hosted collector prototype at db0acff7; post-merge CI, Freeze Guard, CodeQL and Pages passed. The collector is not wired to the active workflow; V0.1 remains active. PR #503 prepares the one-time V0.2 baseline authority proposal; it authorizes no execution. Next decision: whether to authorize that exact bounded bootstrap scope. |

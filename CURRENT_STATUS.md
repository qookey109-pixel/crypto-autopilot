...
| 5 | Tidy historical Actions registrations | TD-014 complete: all 25 removed-file workflow registrations were disabled and read back on 2026-09-25; their run history remains available. The dynamic Dependabot registration and 17 workflows still present as retired source were untouched. See the [dated evidence](docs/GITHUB_ACTIONS_OPERATING_MAP.md#removed-registrations-disabled-2026-09-25). |

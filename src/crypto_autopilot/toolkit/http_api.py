...
API_VERSION = "v0"
SERVICE_NAME = "qookey-crypto-toolkit-api"
...
def health() -> dict[str, Any]:
    return {
        "schema": "qookey-crypto-toolkit-api-health-v0.1",
        "status": "PASS",
...
def openapi_document() -> dict[str, Any]:
    ...
    paths: dict[str, Any] = {
        ...
        "/v0/capabilities": {
            "get": {
                "summary": "List Toolkit capabilities and authority boundary",
    ...
    return {
        ...
        "info": {
            ...
            "version": "0.1.0",
            "description": (
                "Research-only HTTP facade over deterministic Toolkit functions. "

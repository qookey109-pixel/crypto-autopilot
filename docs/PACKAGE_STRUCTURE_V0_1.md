...
| `paper/` | Paper-only exploration, deterministic cycle/session preparation, complete-basket lifecycle coordination, immutable account rematerialization/advance and candidate training |

...
| `paper/` | Paper/live-paper exploration, deterministic cycle/session preparation, tick-by-tick public-market runtime, append-only restartable run coordination, recovery/reconciliation, content-addressed persistence, lifecycle/account/checkpoint handoff, multi-cycle integrity audit, portable run packaging/artifact export and candidate training |

...
| `paper/` | Paper-only exploration, deterministic cycle/session preparation, complete-basket lifecycle coordination, immutable account/position state and candidate training |

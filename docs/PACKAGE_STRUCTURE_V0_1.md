...
| `paper/` | Paper-only exploration, deterministic cycle/session preparation, complete-basket lifecycle coordination, immutable account advance/checkpoint/resume handoff, multi-cycle integrity audit, portable run packaging and candidate training |

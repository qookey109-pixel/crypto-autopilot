...
| `paper/` | Paper-only exploration, deterministic cycle/session preparation, complete-basket lifecycle coordination, immutable account advance/checkpoint handoff and candidate training |
